"""Phase 8's mandatory post-adaptation error-analysis repeat for M1: an
explicit before (Phase 4 zero-transfer, EXP-SIGN-011) vs. after (Phase 8
...
BEFORE_EXPERIMENT_ID = "EXP-SIGN-011"  # Phase 4 zero-transfer
AFTER_EXPERIMENT_ID = "EXP-SIGN-021"  # Phase 8 condition B (winning M1 adapted model)
...
def main() -> None:
    ...
    out_path = out_dir / "post_adaptation_diff_M1.json"
